    ...
    <>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs text-muted">
          <span className="bg-background px-3">o con tu email</span>
        </div>
      </div>
      ...
      <p className="mt-5 text-center text-sm text-muted">
        ¿No tenés cuenta?{" "}
        <Link href="/auth/registro" className="text-brand link-underline">
          Registrate gratis
        </Link>
      </p>
      <p className="mt-2 text-center text-xs text-subtle">
        <Link href="/reservar" className="link-underline">
